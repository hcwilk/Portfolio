...
const desktopPositions = [
    ...
    { x: 20, y: 10, z: -2, URL: "#work", image: 'images/robot.png', label: 'Robotics' },
    { x: 0, y: 18, z: -2, URL: "#work", image: 'images/lock.png', label: 'Cybersecurity' },
    { x: -20, y: 10, z: -2, URL: "#work", image: 'images/code.png', label: 'Full-Stack Development' }
];
...
const mobilePositions = [
    ...
    { x: 12, y: 12, z: -2, URL: "#work", image: 'images/robot.png', label: 'Robotics' },
    { x: 0, y: 14, z: -2, URL: "#work", image: 'images/lock.png', label: 'Cybersecurity' },
    { x: -12, y: 12, z: -2, URL: "#work", image: 'images/code.png', label: 'Software' }
]
