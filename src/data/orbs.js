...
const desktopPositions = [
    ...
    { x: 20, y: 10, z: -2, URL: "#project", image: 'images/project.png', label: 'Projects' },
...
const mobilePositions = [
    ...
    { x: 12, y: 12, z: -2, URL: "#project", image: 'images/robot.png', label: 'Robotics' },
    { x: 0, y: 14, z: -2, URL: "#about", image: 'images/lock.png', label: 'Cybersecurity' },
